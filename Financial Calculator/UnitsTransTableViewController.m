//
//  UnitsTransTableViewController.m
...
#import "UnitsTransTableViewController.h"
#import "UnitsTransViewController.h"
#import "Constants.h"

@interface UnitsTransTableViewController ()

@end

@implementation UnitsTransTableViewController
...
{
    [super viewDidLoad];
    titles = [[NSArray alloc] initWithObjects:@"Length", @"Weight", @"Volume", @"Area", nil];
